...
use app\models\question\{Question, Comment};
use app\models\user\User;


class CommentQuestionTest extends \Codeception\Test\Unit
{
	protected $model;
	protected $question;
    ...
    protected function _before()
    {
    	...
    	$this->model = new Comment(['scenario' => Comment::SCENARIO_CREATE_QUESTION]);
